...
// insert data
router.post('/store', [
        body('namaband').notEmpty(),
        body('tahunbentuk').notEmpty(),
        body('anggotaband').notEmpty(),
        ...
        let formData = {
            namaband: req.body.namaband,
            tahunbentuk: req.body.tahunbentuk,
            anggotaband: req.body.anggotaband,
